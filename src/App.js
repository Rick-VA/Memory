...
function Card({fruit, flipped, chooseCard}) {
    ...
    return <div className={`card ${flipped ? 'matched' : ''}`} onClick={cardClickHandle}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-question-mark" width="24"
      ...
      <h1>Memory Game</h1>
      {
        fruits.length ? <>
            <button onClick={resetGame} className='reset'>
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-reload" width="24"
